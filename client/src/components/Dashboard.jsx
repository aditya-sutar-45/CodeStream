      ...
      <Box height="100vh" width="60vw">
        <Flex mt="3rem" height="50vh" justify="between" align="center">
          ...
          <Box width="40%" style={{textAlign: "end"}} mx="3">
            <Avatar size="9" src="https://images.unsplash.com/photo-1481214110143-ed630356e1bb?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" radius="full" fallback={username[0].toUpperCase()}
              style={{  width: "20rem", height: "20rem" }} />
          </Box>

          {/* <Separator orientation="vertical" style={{height: "90%"}} /> */}

          <Flex width="40%" height="100%" justify="start" mx="3" align="center">
            <Box>
              <Heading weight="bold" as="h1" style={{fontSize: "3rem", height: "40%"}} my="4">{username}</Heading>
              <Heading weight="regular" as="h2" size="4" style={{ color: "gray"}} my="4">{currentUser.email}
              </Heading>
